...
export default function WhatsAppButton() {
  ...
  // Hidden on checkout page to avoid conflicting with the form
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-40 inline-flex items-center gap-0 h-14 rounded-full bg-whatsapp hover:bg-[#1DA851] text-white shadow-lift transition-all duration-300 overflow-hidden safe-bottom"
    >
